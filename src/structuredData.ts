 ...
 *
 * The site origin and contact details come from the build-time snapshot
 * (src/data/site.json), so changing SITE_DOMAIN or the CTA contact updates the
 * structured data too.
 */
...
const PHONE = site.contact.phoneDisplay.startsWith('+')
  ? site.contact.phoneDisplay
  : `+1-${site.contact.phoneDisplay.replace(/^1-/, '')}`;
